...
import type { CreateEmbeddingInput } from "../types/embedding.type.js";
 ...
 */
export async function deleteEmbedding(messageId: string): Promise<number> {
